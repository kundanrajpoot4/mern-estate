  ...
  return (
    <div>
      ...
      <div className=" flex flex-col gap-6 p-28 px-3 
        ...
        <div className="text-gray-400 text-xs sm:text-sm">Kundan Estate is the best
          place to find your next perfect place to
          live.
          <br />
          We have a wide range of property for you
          to choose from.
        </div>
